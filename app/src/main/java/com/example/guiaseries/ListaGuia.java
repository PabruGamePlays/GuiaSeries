...
import androidx.appcompat.app.AppCompatActivity;
import android.os.Bundle;
import com.example.guiaseries.adapter.ToDoAdapter;
...
public class ListaGuia extends AppCompatActivity implements  OnDialogCloseListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonClose = findViewById(R.id.sair);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ListaGuia.this));
        ...
        mList = new ArrayList<>();
        adapter = new ToDoAdapter(ListaGuia.this, mList);
